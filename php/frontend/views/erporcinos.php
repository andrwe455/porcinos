  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Eliminar Porcino</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Eliminar Porcino</li>
            </ol>
          </div>
        </div>
      </div>
            ...
            <form action="/deletePorcino" method="post">
              <div class="card card-danger card-outline">
                ...
                <div class="card-body row">
                  <div class="col-md-12">
                    <div class="form-group">
                      <label for="">Identificación del Porcino</label>
                      <select name="identificacion" id="identificacion" class="form-control">
                        ...
                        <?php
                          foreach ($data as $porcino) {
                            echo "<option value='" . $porcino['_id'] . "'>" . $porcino['identificacion'] . "</option>";
                          }
                        ?>
                      </select>
                    </div>
                ...
                <div class="card-footer">
                  <input type="submit" class="btn btn-danger" value="Eliminar Porcino">
                </div>
              </div>
            </form>
          </div>
